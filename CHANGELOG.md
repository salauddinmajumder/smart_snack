...
## [1.0.7] - 2025-12-14
- Updated screenshot descriptions to accurately match image content
- Descriptions now show exact notification text from screenshots
...
### Fixed
- Fixed Dart formatting issues for pub.dev static analysis
- Reduced screenshots to 10 (pub.dev maximum limit)
- Fixed code style to pass all lint checks
